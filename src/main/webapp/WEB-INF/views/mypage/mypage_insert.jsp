						...
						<fieldset>
							...
							<ul class="reg_list">
								<li class="clear">
									...
									<input required id="user_id" value="${memberVO.user_id}" name="user_id" type="text" class="w100p" placeholder="아이디를 입력해주세요"/>
	...
	$("#user_id").blur(function(){
		...
		$.ajax({
			...
			success:function(result){
				//중복아이디가 존재할때
				if(result=='1') {//ajax에서 주고받는 값은 다 텍스트다. 그래서 '1'이라고쓰는것.
					...
					$("#validation_idcheck").text("사용가능한 아이디입니다.");
