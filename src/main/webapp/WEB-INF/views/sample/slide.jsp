...
body header {
	background: url(/resources/images/back.jpg) no-repeat 50% 55%;
...
@media all and (max-width: 960px) {
	...
	body header a#pull:after {
		content: "";
		background: url('/resources/images/hbg.png') no-repeat;
		width: 30px;
		height: 30px;
		position: absolute;
		right: 0px;
...
<body>
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img src="/resources/images/hawaii.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="item">
  ...
  <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>
	...
	<!-- 니보슬라이더용 비지니스 폼
		<div id="slider" class="nivoSlider">
			<img src="/resources/images/hawaii.jpg" title="슬라이드1" />
			<img src="/resources/images/2.jpg" title="슬라이드1" />
			<img src="/resources/images/3.jpg" title="슬라이드1" />
			<img src="/resources/images/4.jpg" title="슬라이드1" />
		</div>
	-->
	</section>
	<section id="contents" class="row">
		<article id="main">
			...
			<ul>
				<li class="clearfix"><img class="col-4"
					src="/resources/images/hawaii.jpg" alt="" width="296" height="206" />
				...
				<li class="clearfix"><img class="col-8 fr last"
					src="/resources/images/hawaii.jpg" alt="" width="620" height="416" />
					<div class="col-4">
		...
		<article id="sub" class="row clearfix">
			...
			<ul>
				<li class="col-3"><img src="/resources/images/hawaii.jpg"
				...
				<li class="col-6 last"><img src="/resources/images/hawaii.jpg"
